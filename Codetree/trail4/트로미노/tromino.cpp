...
int main() {
    ...
    for(int i=0;i<n;i++)
    {
        for(int j=0;j<n;j++)
        {
            ...
            for(int a=0;a<3;a++)
            {
                if(i+si1[a]>=0 && i+si1[a]<n && j+sj1[a] >=0 && j+sj1[a] <n)
                {
                ...
                if(i+si2[a]>=0 && i+si2[a]<n && j+sj2[a] >=0 && j+sj2[a] <n)
                {
                ...
                if(i+si3[a]>=0 && i+si3[a]<n && j+sj3[a] >=0 && j+sj3[a] <n)
                {
                ...
                if(i+si4[a]>=0 && i+si4[a]<n && j+sj4[a] >=0 && j+sj4[a] <n)
                {
                ...
                if(i+ti1[a]>=0 && i+ti1[a]<n && j+tj1[a] >=0 && j+tj1[a] <n)
                {
                ...
                if(i+ti2[a]>=0 && i+ti2[a]<n && j+tj2[a] >=0 && j+tj2[a] <n)
                {
